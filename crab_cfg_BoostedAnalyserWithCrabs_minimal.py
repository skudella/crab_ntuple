...
config.General.workArea = 'ZPrime_MC_minimal'
...
config.JobType.psetName = '/afs/cern.ch/user/s/skudella/CMSSW_8_0_26_patch2/src/BoostedTTH/BoostedAnalyzer/test/Zprime_ntuples_renormstuff.py'
